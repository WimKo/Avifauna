...
src <- osmsource_file(paste(getwd(), "/1. Data/Raw Data/Grenzen/OSM/Noorderkempen.osm", sep=""))
...
ggsave(file=paste(getwd(), "/3.Plots/OSM/Noorderkempen.pdf", sep=""), width = 10, height = 10, units = "cm")

save(p,data, file=paste(getwd(), "/3.Plots/OSM/Noorderkempen.RDATA", sep=""))
